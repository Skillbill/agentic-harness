...
- **Default**: when the file is absent or unreadable, AH falls back to `contentLanguage = "en"`. This is the new global default, replacing the implicit Italian default that existed up to v0.7.0.
